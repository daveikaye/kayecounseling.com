  ...
  <body>
  	...
  	<div id="content_div" class="content_background_left">
  		<div class="content_background_right">
  		    <div id="accordion">
			  <h3 class="noBorderOrBackground">Individual counseling</h3>
			  <div>
			  ...
			  <h3 class="noBorderOrBackground">Marital couple counseling</h3>
			  <div>
			  ...
			  <h3 class="noBorderOrBackground">Bereavement therapy treatment</h3>
			  <div>
			  ...
			  <h3 class="noBorderOrBackground">Support groups</h3>
			  <div>
			    <ul>
